...
export const GameOverModal: React.FC<GameOverModalProps> = ({
  ...
  if (winner === "draw") {
    title = "Partie Nulle";
    subtitle = "Match nul : il ne reste qu'une seule pièce de chaque côté.";
  } else if (gameMode === "ai") {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="sm" hideCloseButton={false}>
      <div className="text-center py-2">
        {/* Trophy / Icon */}
        <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-[#141414] border border-[#D4AF37]/30 flex items-center justify-center shadow-lg shadow-black/60">
          <Trophy
            className={`w-8 h-8 ${
